...
import { healthScore, healthScoreReason } from "@/data/mockData";
...
export function HealthScoreGauge() {
  ...
  const data = [
    ...
    { value: 100 - displayScore, fill: "transparent" },
  ];
  ...
  return (
    <div className="flex flex-col items-center py-8">
      ...
      <p className="text-xs text-[var(--color-muted)] mt-1">{healthScoreReason}</p>
    </div>
  );
}
*/
